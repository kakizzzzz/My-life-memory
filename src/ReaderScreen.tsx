          ...
          <AnimatePresence>
            {isSaveFeedbackVisible && (
              <motion.div
                ...
                className="pointer-events-none fixed left-1/2 bottom-[calc(env(safe-area-inset-bottom)+7.5rem)] z-[1400] max-w-[min(18rem,calc(100vw-2rem))] -translate-x-1/2 rounded-full bg-black/75 px-4 py-2 text-center text-[13px] font-medium text-white shadow-lg"
              >
                {readerUiCopy.saved}
              </motion.div>
            )}
