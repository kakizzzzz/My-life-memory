...
export function MapControlsOverlay({
  ...
  return (
    <div className="absolute top-[calc(env(safe-area-inset-top)+1.5rem)] right-4 z-[1000] flex flex-col items-end gap-3">
      <button
...
export function TrackingControlsOverlay({
  ...
  return (
    <>
      <div className="absolute top-[calc(env(safe-area-inset-top)+1.5rem)] left-4 z-[1000] bg-[var(--app-active-surface)] rounded-[24px] shadow-md px-6 py-4 border border-[var(--app-card)] min-w-[160px]">
      ...
      <div className="absolute top-[calc(env(safe-area-inset-top)+1.5rem)] right-4 z-[1000]">
        <button
          className={btnClass}
      ...
      <div className="absolute bottom-[calc(env(safe-area-inset-bottom)+7.5rem)] right-4 z-[1000] flex flex-col gap-3">
        <button
          className={btnClass}
          onClick={onCancel}
        >
...
export function MapSearchButton({ btnClass, searchLabel, iconStrokeWidth, onClick }: MapSearchButtonProps) {
  return (
    <div className="absolute bottom-[calc(env(safe-area-inset-bottom)+7.5rem)] right-4 z-[1000]">
      <button
        className={btnClass}
        onClick={onClick}
