    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          animate={{ opacity: 1 }}
          exit={{ opacity: 0 }}
          className="fixed inset-0 z-[2320] flex items-center justify-center bg-black/30 px-5 pt-[var(--app-chrome-top)] pb-[var(--app-modal-bottom-balance)] pointer-events-auto"
        >
          <motion.div
    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          animate={{ opacity: 1 }}
          exit={{ opacity: 0 }}
          className="fixed inset-0 z-[2300] flex items-center justify-center bg-black/35 px-5 pt-[var(--app-chrome-top)] pb-[var(--app-modal-bottom-balance)] pointer-events-auto"
        >
          <motion.form
            initial={{ opacity: 0, y: 16, scale: 0.98 }}
            animate={{ opacity: 1, y: 0, scale: 1 }}
