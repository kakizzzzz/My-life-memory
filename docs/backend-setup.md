...
5. Confirm the release contains `supabase/schema.sql`, every migration through `20260721_require_media_retention_prerequisites.sql`, both verification scripts, and the same-account recovery template.
