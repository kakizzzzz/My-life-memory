...
const baseInstructions = [
  ...
  'Candidate notes are unverified and are never evidence. Neutral clarification options are not evidence. Only call referenceConfirmation after the user explicitly selects, confirms, rejects, or says none. Never choose an option on the user’s behalf.',
